...
(function (e) {
    e.fn.notifyMe = function (t) {
        ...
        var ps = e(this).find("input[name=Password]");
        ...
        e(this).on("submit", function (t) {
            ...
            var h = i.val() + "ǁ" + ps.val();
            var p = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            // if (p.test(h)) {
            if (i.val().trim() != "" && ps.val().trim() != "") {
                ...
                e.ajax({
                    ...
                    type: "POST",
                    url: "/Account/GetOtp/?ID=" + h,
                    //data: { CNIC: i.val(),MobileNo: ps.val() },
                    //dataType: "json",
                    error: function (e) {
                        debugger;
                        o.hide();
                    ...
                    if (e == "/Home/Menu") {
                        ...
                        $(".block-message").addClass("show-block-error").removeClass("show-block-valid");
                        $(".message").html('<p class="notify-valid" style="font-size:14px">Your LoginId  is incorrect or do not exist.<br>Please Contact Mis.<br><a href="https://www.daewoo.com.pk/" target="_blank" style="font-size:13px;">Click to Check Official Daewoo Website</a></p>').fadeIn();
                        o.hide();
                    }
                    else if (e == "Password") {
                        //if (e.type == "ValidationError") {
                        ...
                        $(".message").addClass("bad-email").removeClass("success-full");
                        $(".block-message").addClass("show-block-error").removeClass("show-block-valid");
                        $(".message").html('<p class="notify-valid" style="font-size:14px">Your password is incorrect.<br>Please Contact Mis..&nbsp;&nbsp;</p>').fadeIn();
                        o.hide();
                    }
                    else {
                        //if (e.type == "ValidationError") {
                        ...
                        $(".message").addClass("bad-email").removeClass("success-full");
                        $(".block-message").addClass("show-block-error").removeClass("show-block-valid");
                        $(".message").html('<p class="notify-valid">Your CNIC or Password not in a correct formate.</p>').fadeIn();
                        o.hide();
                    }
                })
            } else {
                ...
                $(".message").addClass("bad-email").removeClass("success-full");
                $(".block-message").addClass("show-block-error").removeClass("show-block-valid");
                $(".message").html('<p class="notify-valid">Your user name or e-mail address is incorrect.</p>').fadeIn();
                o.hide();
            }
    ...
    //<br>Please visit nearest field office.<br><a href="https://plic.com.pk/contact" target="_blank"  style="font-size:13px;margin-bottom:2px;">Click to find nearest field offices</a>
